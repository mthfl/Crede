            ...
            <main class="p-4 sm:p-6 lg:p-8">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="candidatos.php" class="bg-primary text-white px-4 py-3 rounded-xl hover:bg-dark transition-all duration-300 font-medium text-sm btn-animate focus-ring">Voltar para Ativos</a>
                    </div>
                </div>
                                        ...
                                        <?php if (isset($_SESSION['tipo_usuario']) && $_SESSION['tipo_usuario'] === 'admin') { ?>
                                            <td class="px-6 py-4">
                                                <div class="flex space-x-2 justify-center">
                                                    <button type="button" onclick="openActivateModal(<?= $id ?>, '<?= htmlspecialchars($nome) ?>')" class="inline-flex items-center bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-all duration-300 font-medium text-sm btn-animate focus-ring">
