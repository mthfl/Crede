            ...
            <main class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="mb-6">
                    <div class="relative max-w-md">
                        <input type="text" id="searchInput" placeholder="Pesquisar por nome do candidato..." class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all text-sm" onkeyup="filterCandidates()">
