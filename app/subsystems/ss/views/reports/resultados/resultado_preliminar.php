...
class relatorios extends connect
{
    ...
    /**
     * Cria a capa do relatório preliminar
     */
    ...
    public function gerarRelatorioPreliminar()
    {
        ...
        $pdf->SetY(8);
        $pdf->SetX(9);
        $pdf->Cell(0, 8, mb_convert_encoding('RESULTADO PRELIMINAR', 'ISO-8859-1', 'UTF-8'), 0, 1, 'L');
        ...
        $pdf->Output('I', 'resultado_preliminar.pdf');
    }
...
// Chamar o relatório preliminar
$relatorios = new relatorios($escola);
$relatorios->gerarRelatorioPreliminar();